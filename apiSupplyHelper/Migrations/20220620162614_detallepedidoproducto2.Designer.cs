...
namespace apiSupplyHelper.Migrations
{
    ...
    [Migration("20220620162614_detallepedidoproducto2")]
    partial class detallepedidoproducto2
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("apiSupplyHelper.Detalle_Pedido.Modelos.detallePedidoProducto", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
                    ...
                    b.ToTable("detallePedidoProductos");
                });

            modelBuilder.Entity("apiSupplyHelper.Detalle_Pedido.Modelos.Pedido", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("apiSupplyHelper.Detalle_Pedido.Modelos.detallePedidoProducto", b =>
                {
                    b.HasOne("apiSupplyHelper.Detalle_Pedido.Modelos.Pedido", "Pedido")
                        .WithMany()
                        .HasForeignKey("PedidoId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("apiSupplyHelper.DetalleProveedor.Modelos.ProductoProveedor", "ProductoProveedor")
            ...
            modelBuilder.Entity("apiSupplyHelper.Detalle_Pedido.Modelos.Pedido", b =>
                {
                    b.HasOne("apiSupplyHelper.Data.Models.Auth.User", "User")
                        .WithMany()
            ...
            modelBuilder.Entity("apiSupplyHelper.Proveedores.Modelos.Proveedor", b =>
                {
                    ...
                    b.Navigation("ServicioProveedores");
                });
